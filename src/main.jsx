...
import { ArrowRight, Cable, Camera, CheckCircle2, Cpu, Mail, MapPin, Menu, Monitor, PackageSearch, Phone, Printer, ShieldCheck, Sparkles, Wrench, X } from 'lucide-react';
...
function ProductCard({ product }) { const subject = encodeURIComponent('Product enquiry'); const body = encodeURIComponent(`Hi Compustar,\n\nI would like to enquire about the product shown on the website.\n\nPlease confirm availability and details.\n`); return <article className="product-card gallery-card" data-reveal><div className="product-image"><img src={`/products/${product.file}`} alt="Compustar product" loading="lazy" /></div><div className="product-overlay"><a href={`mailto:${email}?subject=${subject}&body=${body}`}>Enquire <ArrowRight size={16} /></a></div></article>; }
function Footer() {
